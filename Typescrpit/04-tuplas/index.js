"use strict";
let point; //estou especifiquando que na minha tupla so tem tres elementos (array)
point = [1, 12, 45];
console.log(point);
...
console.log(nomes[0])
*/
let mistura; //Tambem posso declara uma tupla com varios elementos diferentes.
